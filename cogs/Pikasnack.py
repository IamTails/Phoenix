...
class Snacktime:
    """The Snackburr's passing out rare candy jars!"""
    def __init__(self,bot):
        ...
        self.startPhrases = [
            "`ϞϞ(๑⚈ ․̫ ⚈๑)∩ < It's snack time!`",
            "`ϞϞ(๑⚈ ․̫ ⚈๑)∩ < I'm back with s'more snacks! Who wants!?`",
            "`ϞϞ(๑⚈ ․̫ ⚈๑)∩ < I'm back errbody! Who wants some snacks!?`",
            "`ϞϞ(๑⚈ ․̫ ⚈๑)∩ < Woo man those errands are crazy! Anyways, anybody want some snacks?`",
            "`ϞϞ(๑⚈ ․̫ ⚈๑)∩ < I got snacks! If nobody wants em, I'm gonna eat em all!!`",
            "`ϞϞ(๑⚈ ․̫ ⚈๑)∩ < Hey, I'm back! Anybody in the mood for some snacks?!`",
            "`ϞϞ(๑⚈ ․̫ ⚈๑)∩ < Heyyaaayayyyaya! I say Hey, I got snacks!`",
            "`ϞϞ(๑⚈ ․̫ ⚈๑)∩ < Heyyaaayayyyaya! I say Hey, What's goin on?... I uh.. I got snacks.`",
            "`ϞϞ(๑⚈ ․̫ ⚈๑)∩ < If anybody has reason why these snacks and my belly should not be wed, speak now or forever hold your peace!`",
            "`ϞϞ(๑⚈ ․̫ ⚈๑)∩ < Got another snack delivery guys!`",
            "`ϞϞ(๑⚈ ․̫ ⚈๑)∩ < Did somebody say snacks?!?! o/`",
            "`ϞϞ(๑⚈ ․̫ ⚈๑)∩ < Choo Choo! it's the rare candy train! Come on over guys!`",
            "`ϞϞ(๑⚈ ․̫ ⚈๑)∩ < Snacks are here! Dig in! Who wants a plate?`",
            "`ʕ >ᴥ>ʔ < Pstt.. I got the snacks you were lookin for. <.<`",
            "`ϞϞ(๑⚈ ․̫ ⚈๑)∩ < I hope you guys are hungry! Cause i'm loaded to the brim with snacks!!!`",
            "`ϞϞ(๑⚈ ․̫ ⚈๑)∩ < I was hungry on the way over so I kinda started without you guys :3 Who wants snacks!?!`",
            "`ϞϞ(๑⚈ ․̫ ⚈๑)∩ < Beep beep! I got a snack delivery comin in! Who wants snacks!`",
            "`ϞϞ(๑⚈ ․̫ ⚈๑)∩ < Guess what time it is?! It's snacktime!! Who wants?!`",
            "`ϞϞ(๑⚈ ․̫ ⚈๑)∩ < Hey check out this sweet stach o' snacks I found! Who wants a cut?`",
            "`ϞϞ(๑⚈ ․̫ ⚈๑)∩ < Who's ready to gobble down some snacks!?`",
            "`ϞϞ(๑⚈ ․̫ ⚈๑)∩ < So who's gonna help me eat all these snacks? :3`"
        ]
        self.outPhrases = [
            "`ϞϞ(๑⚈ ․̫ ⚈๑)∩ < I'm out of snacks! I'll be back with more soon.`",
            "`ϞϞ(๑⚈ ․̫ ⚈๑)∩ < I'm out of snacks :( I'll be back soon with more!`",
            "`ϞϞ(๑⚈ ․̫ ⚈๑)∩ < Aight, I gotta head out! I'll be back with more, don worry :3`",
            "`ϞϞ(๑⚈ ․̫ ⚈๑)∩ < Alright, I gotta get back to my errands. I'll see you guys soon!`"
        ]
        self.notakersPhrases = [
            "`ϞϞ(๑⚈ ․̫ ⚈๑)∩ < I guess nobody wants snacks... more for me!`",
            "`ϞϞ(๑⚈ ․̫ ⚈๑)∩ < Guess nobody's here.. I'll just head out then`",
            "`ϞϞ(๑⚈ ․̫ ⚈๑)∩ < I don't see anybody.. <.< ... >.> ... All the snacks for me!!`",
            "`ϞϞ(๑⚈ ․̫ ⚈๑)∩ < I guess nobody wants snacks huh.. Well, I'll come back later`",
            "`ϞϞ(๑⚈ ․̫ ⚈๑)∩ < I guess i'll just come back later..`"
        ]
        self.givePhrases = [
            "`ϞϞ(๑⚈ ․̫ ⚈๑)∩ < Here ya go, {0}, here's {1} rare candy!`",
            "`ϞϞ(๑⚈ ․̫ ⚈๑)∩ < Alright here ya go, {0}, {1} rare candy for you!`",
            "`ϞϞ(๑⚈ ․̫ ⚈๑)∩ < Yeah! Here you go, {0}! {1} rare candy!`",
            "`ϞϞ(๑⚈ ․̫ ⚈๑)∩ < Of course {0}! Here's {1} rare candy!`",
            "`ϞϞ(๑⚈ ․̫ ⚈๑)∩ < Ok {0}, here's {1} rare candy for you. Anyone else want some?`",
            "`ϞϞ(๑⚈ ․̫ ⚈๑)∩ < Alllright, {1} rare candy for {0}!`",
            "`ϞϞ(๑⚈ ․̫ ⚈๑)∩ < Hold your horses {0}! Alright, {1} rare candy for you :)`"
        ]
        self.lastsecondPhrases = [
            "`ϞϞ(๑⚈ ․̫ ⚈๑)∩ < Fine fine, {0}, I'll give you {1} of my on-the-road rare candy.. Cya!`",
            "`ϞϞ(๑⚈ ․̫ ⚈๑)∩ < Oh! {0}, you caught me right before I left! Alright, i'll give you {1} of my own rare candy`"
        ]
        self.greedyPhrases = [
            "`ϞϞ(๑⚈ ․̫ ⚈๑)∩ < Don't be greedy now! you already got some rare candy {0}!`",
            "`ϞϞ(๑⚈ ․̫ ⚈๑)∩ < You already got your snacks {0}!`",
            "`ϞϞ(๑⚈ ․̫ ⚈๑)∩ < Come on {0}, you already got your snacks! We gotta make sure there's some for errbody!`"
        ]
        self.nobankPhrases = [
            "`ϞϞ(๑⚈ ․̫ ⚈๑)∩ < You don't have a rare candy bank account, {0}! But here ya go, you can just eat these {1} rare candy jars!`",
            "`ϞϞ(๑⚈ ․̫ ⚈๑)∩ < Dang, {0}! You don't have a rare candy bank account. Are you just gonna eat these {1} rare candy jars?!`",
            "`ϞϞ(๑⚈ ․̫ ⚈๑)∩ < {0}, you don't really have a place to put these {1} rare candy jars, but I'll give em to you to eat here n now :)`"
        ]
    ...
    async def amount(self, ctx, amt : int):
        """How much rare candy max snackburr should give out to each person per snacktime"""
        scid = ctx.message.server.id+"-"+ctx.message.channel.id
        if amt <= 0:
            await self.bot.say("amount must be greater than 0")
        else:
            self.settings[scid]["SNACK_AMOUNT"] = amt
            await self.bot.say("snackburr will now give out " + str(self.settings[scid]["SNACK_AMOUNT"]) + " rare candy max per person per snacktime.")
            fileIO("data/snacktime/settings.json", "save", self.settings)
    ...
    async def deliver(self, ctx):
        ...
        if self.channels[scid]:
            await self.bot.say("`ϞϞ(๑⚈ ․̫ ⚈๑)∩ < Oh you guys want snacks?! Aight, I'll come around every so often to hand some out!`")
        else:
            await self.bot.say("`ϞϞ(๑⚈ ․̫ ⚈๑)∩ < You guys don't want snacks anymore? Alright, I'll stop comin around.`")
        ...
        try:
            ...
            if self.alreadySnacked.get(scid,False):
                ...
                if self.repeatMissedSnacktimes[scid] > 9: #move to a setting
                    await self.bot.send_message(message.channel, "`ϞϞ(๑⚈ ․̫ ⚈๑)∩ < I guess you guys don't like snacktimes.. I'll stop comin around.`")
                    self.channels[scid] = False
                    fileIO("data/snacktime/channels.json", "save", self.channels)
                    self.repeatMissedSnacktimes[scid] = 0
                fileIO("data/snacktime/repeatMissedSnacktimes.json", "save", self.repeatMissedSnacktimes)
                    ...
                    if userWants:
                        ...
                        if self.econ.bank.account_exists(message.author):
                            try:
                                ...
                                print("Failed to send message. " + message.author.name + " didn't get rare candy")
