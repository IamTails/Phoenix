...
import phoenix.bot.pogo.api.cache.*
import phoenix.bot.pogo.api.cache.Map
import phoenix.bot.pogo.api.map.GetMapObjects
import phoenix.bot.pogo.api.network.ActionQueue
import phoenix.bot.pogo.api.network.ServerRequest
import phoenix.bot.pogo.api.request.*
import phoenix.bot.pogo.api.util.*
        ...
        thread {
            try {
                ByteArrayOutputStream().use({ output ->
                    ...
                    val call = okhttp3.Request.Builder().url("").post(body).build()
                    try {
