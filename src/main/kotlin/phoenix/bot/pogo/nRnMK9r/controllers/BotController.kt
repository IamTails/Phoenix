...
package phoenix.bot.pogo.nRnMK9r.controllers
...
import phoenix.bot.pogo.api.request.*
...
import phoenix.bot.pogo.nRnMK9r.util.ApiAuthProvider
import phoenix.bot.pogo.nRnMK9r.util.Log
import phoenix.bot.pogo.nRnMK9r.util.credentials.GoogleAutoCredentials
import phoenix.bot.pogo.nRnMK9r.util.data.*
import phoenix.bot.pogo.nRnMK9r.util.pokemon.candyCostsForPowerup
import phoenix.bot.pogo.nRnMK9r.util.pokemon.getStatsFormatted
import phoenix.bot.pogo.nRnMK9r.util.pokemon.meta
import phoenix.bot.pogo.nRnMK9r.util.pokemon.stardustCostsForPowerup
