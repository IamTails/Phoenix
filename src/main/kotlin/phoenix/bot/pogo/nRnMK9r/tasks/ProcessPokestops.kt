...
import phoenix.bot.pogo.nRnMK9r.util.map.distance
import phoenix.bot.pogo.nRnMK9r.util.pokemon.distance
import phoenix.bot.pogo.nRnMK9r.util.map.inRangeForLuredPokemon
import java.util.*
