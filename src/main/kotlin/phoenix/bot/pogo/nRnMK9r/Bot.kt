...
import phoenix.bot.pogo.nRnMK9r.gui.SocketServer
import phoenix.bot.pogo.nRnMK9r.tasks.*
import phoenix.bot.pogo.nRnMK9r.util.Log
import phoenix.bot.pogo.nRnMK9r.util.directions.RouteProviderEnum
import phoenix.bot.pogo.nRnMK9r.util.directions.getAltitude
import phoenix.bot.pogo.nRnMK9r.util.io.SettingsJSONWriter
...
class Bot(val api: PoGoApi, val settings: Settings) {
    ...
    fun start() {
        ...
        if (settings.guiPortSocket > 0) {
            ...
            Log.green("Ui site down use the apk")
        }
